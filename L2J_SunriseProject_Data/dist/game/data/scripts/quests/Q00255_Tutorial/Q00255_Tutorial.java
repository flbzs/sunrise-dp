			...
			if (st.getPlayer().getLevel() < 6)
			{
				...
				else
				{
					if (uc == 1)
					{
						...
						st.playSound(QuestSound.VOICE_TUTORIAL_VOICE_006);
						...
						else
						{
							...
							else
							{
								...
								else
								{
									...
									{
										if ((st.getPlayer().getLevel() == 79) && ((qs == null) || (qs.getState() == State.CREATED)))
										{
											st.playSound(QuestSound.ITEMSOUND_QUEST_TUTORIAL);
		...
		else
		{
			if (event.startsWith("QT"))
			{
				...
				else
				{
					if (Ex == -3)
					{
						st.playSound(QuestSound.VOICE_TUTORIAL_VOICE_002);
						st.set("Ex", "0");
					}
					else
					{
						if (Ex == -4)
						{
							st.playSound(QuestSound.VOICE_TUTORIAL_VOICE_008);
							st.set("Ex", "-5");
						}
					}
				}
			...
			else
			{
				if (event.startsWith("TE"))
				{
					...
					else
					{
						...
						else
						{
							if (event_id == 2)
							{
								st.playSound(QuestSound.VOICE_TUTORIAL_VOICE_003);
											...
											else
											{
												...
												else
												{
													...
													else
													{
														...
														{
															if ((event_id == 24) && TCLc.containsKey(classId))
															{
															...
															else
															{
																...
																{
																	if ((event_id == 26) && TCLa.containsKey(classId))
																	{
				...
				else
				{
					if (event.startsWith("CE"))
					{
						...
						{
							st.playSound(QuestSound.VOICE_TUTORIAL_VOICE_004);
							htmlText = "tutorial_03.htm";
							st.playSound(QuestSound.ITEMSOUND_QUEST_TUTORIAL);
							st.onTutorialClientEvent(2);
						}
						...
						{
							if ((event_id == 2) && (st.getPlayer().getLevel() < 6))
							{
								st.playSound(QuestSound.VOICE_TUTORIAL_VOICE_005);
								htmlText = "tutorial_05.htm";
								st.playSound(QuestSound.ITEMSOUND_QUEST_TUTORIAL);
								st.onTutorialClientEvent(8);
							}
							...
							{
								if ((event_id == 8) && (st.getPlayer().getLevel() < 6))
								{
									int x = 0;
									int y = 0;
									int z = 0;
									...
									if (x != 0)
									{
										st.playSound(QuestSound.ITEMSOUND_QUEST_TUTORIAL);
										st.addRadar(x, y, z);
										st.playSound(QuestSound.VOICE_TUTORIAL_VOICE_007);
										st.set("ucMemo", "1");
										st.set("Ex", "-5");
									}
								}
								...
								{
									if ((event_id == 30) && (st.getPlayer().getLevel() < 6) && (st.getInt("Die") == 0))
									{
										st.playSound(QuestSound.VOICE_TUTORIAL_VOICE_016);
										st.playSound(QuestSound.ITEMSOUND_QUEST_TUTORIAL);
										st.set("Die", "1");
									...
									{
										if ((event_id == 2144337408) && (st.getPlayer().getLevel() < 6) && (st.getInt("sit") == 0))
										{
											st.playSound(QuestSound.VOICE_TUTORIAL_VOICE_018);
											st.playSound(QuestSound.ITEMSOUND_QUEST_TUTORIAL);
											st.set("sit", "1");
											st.onTutorialClientEvent(0);
										...
										else
										{
											if (event_id == 40)
											{
												if (st.getPlayer().getLevel() == 5)
												{
													...
													{
														st.playSound(QuestSound.VOICE_TUTORIAL_VOICE_014);
												...
												if (st.getPlayer().getLevel() == 6)
												{
													...
													{
														st.playSound(QuestSound.VOICE_TUTORIAL_VOICE_020);
														st.playSound(QuestSound.ITEMSOUND_QUEST_TUTORIAL);
											...
											else
											{
												...
												{
													if ((event_id == 45) && (st.getPlayer().getLevel() < 6) && (st.getInt("HP") == 0))
													{
														st.playSound(QuestSound.VOICE_TUTORIAL_VOICE_017);
														st.playSound(QuestSound.ITEMSOUND_QUEST_TUTORIAL);
														st.set("HP", "1");
													...
													{
														if ((event_id == 57) && (st.getPlayer().getLevel() < 6) && (st.getInt("Adena") == 0))
														{
															st.playSound(QuestSound.VOICE_TUTORIAL_VOICE_012);
															st.playSound(QuestSound.ITEMSOUND_QUEST_TUTORIAL);
															st.set("Adena", "1");
														...
														{
															if ((event_id == 6353) && (st.getPlayer().getLevel() < 6) && (st.getInt("Gemstone") == 0))
															{
																st.playSound(QuestSound.VOICE_TUTORIAL_VOICE_013);
																st.playSound(QuestSound.ITEMSOUND_QUEST_TUTORIAL);
																st.set("Gemstone", "1");
																st.showQuestionMark(5);
															}
															...
															{
																if ((event_id == 1048576) && (st.getPlayer().getLevel() < 6))
																{
																	st.showQuestionMark(5);
																	st.playSound(QuestSound.VOICE_TUTORIAL_VOICE_013);
																	st.playSound(QuestSound.ITEMSOUND_QUEST_TUTORIAL);
